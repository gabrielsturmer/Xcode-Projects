...
/*- (void)loadView {
    GMSCameraPosition *camera = [GMSCameraPosition cameraWithLatitude:-30.019003
                                                            longitude:-51.160632
                                                                 zoom:15];
    ...
    GMSMarkerOptions *options2 = [[GMSMarkerOptions alloc] init];
    options2.position = CLLocationCoordinate2DMake(-30.019002,-51.161642);
    options2.title = @"Name 2";
    options2.snippet = @"tipo de lugar";
    [mapView_ addMarkerWithOptions:options2];
}*/
